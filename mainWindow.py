...
################################################################################
## Form generated from reading UI file 'V0.1.ui'
##
...
"")
        ...
        self.centerMenuContainer.setMinimumSize(QSize(200, 200))
        ...
        self.centerMenuPagesPage1 = QWidget()
        self.centerMenuPagesPage1.setObjectName(u"centerMenuPagesPage1")
        self.verticalLayout_8 = QVBoxLayout(self.centerMenuPagesPage1)
        self.verticalLayout_8.setObjectName(u"verticalLayout_8")
        self.label_2 = QLabel(self.centerMenuPagesPage1)
        ...
        self.centerMenuPagesPage2 = QWidget()
        self.centerMenuPagesPage2.setObjectName(u"centerMenuPagesPage2")
        self.verticalLayout_9 = QVBoxLayout(self.centerMenuPagesPage2)
        self.verticalLayout_9.setObjectName(u"verticalLayout_9")
        self.label_3 = QLabel(self.centerMenuPagesPage2)
        ...
        self.centerMenuPagesPage3 = QWidget()
        self.centerMenuPagesPage3.setObjectName(u"centerMenuPagesPage3")
        self.verticalLayout_10 = QVBoxLayout(self.centerMenuPagesPage3)
        self.verticalLayout_10.setObjectName(u"verticalLayout_10")
        self.label_4 = QLabel(self.centerMenuPagesPage3)
        ...
        self.mainPages = QStackedWidget(self.mainContentContainer)
        self.mainPages.setObjectName(u"mainPages")
        self.mainPagesPage1 = QWidget()
        self.mainPagesPage1.setObjectName(u"mainPagesPage1")
        self.horizontalLayout_12 = QHBoxLayout(self.mainPagesPage1)
        self.horizontalLayout_12.setSpacing(0)
        self.horizontalLayout_12.setObjectName(u"horizontalLayout_12")
        self.horizontalLayout_12.setContentsMargins(0, 0, 0, -1)
        self.webcamWidget = QWidget(self.mainPagesPage1)
        ...
        self.gridLayout = QGridLayout(self.webcamWidget)
        ...
        self.expandCamSettings = QPushButton(self.mainPagesPage1)
        ...
        self.rightMenuContainer = QFrame(self.mainPagesPage1)
        self.rightMenuContainer.setObjectName(u"rightMenuContainer")
        self.rightMenuContainer.setMinimumSize(QSize(300, 0))
        self.rightMenuContainer.setMaximumSize(QSize(300, 11000))
        ...
        self.rightMenuPagesPage1 = QWidget()
        self.rightMenuPagesPage1.setObjectName(u"rightMenuPagesPage1")
        self.verticalLayout_15 = QVBoxLayout(self.rightMenuPagesPage1)
        self.verticalLayout_15.setObjectName(u"verticalLayout_15")
        self.cameraComboboxListFrame = QFrame(self.rightMenuPagesPage1)
        self.cameraComboboxListFrame.setObjectName(u"cameraComboboxListFrame")
        self.cameraComboboxListFrame.setFrameShape(QFrame.StyledPanel)
        self.cameraComboboxListFrame.setFrameShadow(QFrame.Raised)
        self.verticalLayout_20 = QVBoxLayout(self.cameraComboboxListFrame)
        self.verticalLayout_20.setObjectName(u"verticalLayout_20")
        self.screencountCombobox = QComboBox(self.cameraComboboxListFrame)
        icon17 = QIcon()
        ...
        self.verticalLayout_20.addWidget(self.screencountCombobox, 0, Qt.AlignTop)


        self.verticalLayout_15.addWidget(self.cameraComboboxListFrame)

        self.otherCameraSettings = QFrame(self.rightMenuPagesPage1)
        self.otherCameraSettings.setObjectName(u"otherCameraSettings")
        self.otherCameraSettings.setFrameShape(QFrame.StyledPanel)
        self.otherCameraSettings.setFrameShadow(QFrame.Raised)

        self.verticalLayout_15.addWidget(self.otherCameraSettings)

        self.rightMenuPages.addWidget(self.rightMenuPagesPage1)
        self.rightMenuPagesPage2 = QWidget()
        self.rightMenuPagesPage2.setObjectName(u"rightMenuPagesPage2")
        self.verticalLayout_13 = QVBoxLayout(self.rightMenuPagesPage2)
        self.verticalLayout_13.setObjectName(u"verticalLayout_13")
        self.frame_10 = QFrame(self.rightMenuPagesPage2)
        ...
        self.frame_11 = QFrame(self.rightMenuPagesPage2)
        ...
        self.mainPagesPage2 = QWidget()
        self.mainPagesPage2.setObjectName(u"mainPagesPage2")
        self.verticalLayout_17 = QVBoxLayout(self.mainPagesPage2)
        self.verticalLayout_17.setObjectName(u"verticalLayout_17")
        self.label_10 = QLabel(self.mainPagesPage2)
        ...
        self.mainPagesPage3 = QWidget()
        self.mainPagesPage3.setObjectName(u"mainPagesPage3")
        self.verticalLayout_16 = QVBoxLayout(self.mainPagesPage3)
        self.verticalLayout_16.setObjectName(u"verticalLayout_16")
        self.label_9 = QLabel(self.mainPagesPage3)
        ...
        self.popUpNotificationContainer = QFrame(self.mainBodyContainer)
